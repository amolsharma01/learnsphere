...
export default function About() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <h1 className="text-4xl font-bold text-center text-primary mb-8">About LearnSphere</h1>
      <div className="space-y-8">
        <section className="text-center">
          <p className="text-xl text-muted-foreground">
            At LearnSphere, we believe education is the cornerstone of progress and personal growth. Our mission is to
        ...
        <section>
          <p className="mb-4">
            LearnSphere is more than just an eLearning platform—it&apos;s a community of learners, educators, and
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-6">What sets LearnSphere apart:</h2>
        ...
        <section className="text-center">
          <p className="mb-4">
            Whether you&apos;re preparing for a new career, upgrading your skills, or exploring your passions, LearnSphere
          ...
          <p className="text-2xl font-semibold text-primary">
            Elevate your learning. Elevate your future. LearnSphere.
          </p>
        </section>
      </div>
    </div>
